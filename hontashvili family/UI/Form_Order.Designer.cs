...
namespace hontashvili_family.UI
{
    partial class Form_Order
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Order_items.Controls.Add(this.button_Plus);
            this.Order_items.Controls.Add(this.button_Minus);
            this.Order_items.Controls.Add(this.listBox_ProductsInOrderCount);
